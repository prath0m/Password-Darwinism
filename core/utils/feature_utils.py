...
vocab_set = pd.read_csv("core/input/ngram_freq.csv")
...
# new_vocab_df.to_csv('core/input/vocab_tier.csv')
...
model_path = 'core/input/model.h5'  # Adjust if your .h5 file is elsewhere
model = load_model(model_path)

from tokenizers import ByteLevelBPETokenizer

vocab_path = "core/input/vocab.json"
merges_path = "core/input/merges.txt"    
...
with open('core/input/top10000common.json', 'w') as json_file:
    json.dump(my_dict, json_file, indent=4)
# print(json_output)

# new_vocab_df.to_csv('vocab_tier.csv', index=False)

with open("core/input/top10000common.json" , "r",encoding = "utf-8")as file:
...
with open("core/input/data.json", "r") as file:
